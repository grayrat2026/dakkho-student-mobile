...
const styles = StyleSheet.create({
  ...
  backBtn: { marginBottom: 16 }, iconContainer: { alignItems: 'center', marginBottom: 16 },
  ...
  label: { fontSize: 12, fontWeight: '600', marginBottom: 6 }, inputRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 12, height: 48, borderRadius: 12, borderWidth: 2, borderColor: 'transparent', marginBottom: 20 },
  input: { flex: 1, fontSize: 14, paddingVertical: 0 }, sendBtn: { borderRadius: 12, overflow: 'hidden' },
  sendGradient: { paddingVertical: 16, alignItems: 'center', justifyContent: 'center' }, sendText: { color: '#fff', fontSize: 16, fontWeight: '700' },
  successBox: { alignItems: 'center', gap: 16 }, successText: { fontSize: 14, color: '#10b981', fontWeight: '600', textAlign: 'center' },
