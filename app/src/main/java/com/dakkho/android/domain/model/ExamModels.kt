...
// ════════════════════════════════════════════════════
// DTOs (top-level for Moshi codegen)
// ════════════════════════════════════════════════════
...
data class ExamScheduleDto(
    ...
    fun toDomain(): ExamModels.ExamSchedule = ExamModels.ExamSchedule(
...
data class ExamResultDto(
    ...
    fun toDomain(): ExamModels.ExamResult = ExamModels.ExamResult(
...
data class SubjectResultDto(
    ...
    fun toDomain(): ExamModels.SubjectResult = ExamModels.SubjectResult(
