          ...
          <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
            ...
            >
              ...
              <MotiView from={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 400 }}>
                ...
                {password ? (
                  <Text style={{ fontSize: 12, color: passwordStrength.color, marginTop: 4 }}>
...
const styles = StyleSheet.create({
  ...
  card: {
    backgroundColor: 'rgba(255,255,255,0.7)', borderRadius: 24,
    padding: 24, shadowColor: '#0ea5e9', shadowOffset: { width: 0, height: 10 },
    shadowOpacity: 0.1, shadowRadius: 15, elevation: 5, borderWidth: 1,
  ...
  inputRow: {
    ...
    paddingHorizontal: 12, height: 48, borderRadius: 12, borderWidth: 2, marginBottom: 16,
  },
  ...
  otpBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
    paddingVertical: 12, borderRadius: 12, borderWidth: 2, borderStyle: 'dashed',
    borderColor: 'rgba(148,163,184,0.3)', marginBottom: 16,
  },
  otpText: { fontSize: 14 },
